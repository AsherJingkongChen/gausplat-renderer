    ...
    pub fn render(
        ...
        impl Backward<Wgpu, 3, 1> for BackwardOps {
            ...
            fn backward(
                ...
                // loss l1: 0.23170578479766846 [23/08 23:14:02]
                // loss lmssim: 0.27757564187049866 [23/08 23:14:02]
                // loss: 0.329849511384964 [23/08 23:14:02]
                // {'grad_out_color': {'max': 1.5975578207871877e-05,
                //                     'mean': -1.9003134354989015e-07,
                //                     'min': -1.406932369718561e-05}} [23/08 23:14:02]
                // {'grad_colors_precomp': -3.204200904605159e-09,
                //  'grad_cov3Ds_precomp': -0.00041207735193893313,
                //  'grad_means2D_norm': 2.0923815100104548e-05,
                //  'grad_means3D': -6.222057180593765e-08,
                //  'grad_opacities': -1.6489806284880615e-06,
                //  'grad_rotations': 5.430579687753536e-16,
                //  'grad_scales': -3.72117392544169e-06,
                //  'grad_sh': -5.649297349363813e-11} [23/08 23:14:02]
            }
        }
